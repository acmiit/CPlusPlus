...
class ReqSignup final :
 ...
 public:
  ...
  // string passsword = 2;
  void clear_passsword();
  const std::string& passsword() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_passsword(ArgT0&& arg0, ArgT... args);
  std::string* mutable_passsword();
  PROTOBUF_NODISCARD std::string* release_passsword();
  void set_allocated_passsword(std::string* passsword);
  private:
  const std::string& _internal_passsword() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_passsword(const std::string& value);
  std::string* _internal_mutable_passsword();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr passsword_;
...
// string passsword = 2;
inline void ReqSignup::clear_passsword() {
  passsword_.ClearToEmpty();
}
inline const std::string& ReqSignup::passsword() const {
  // @@protoc_insertion_point(field_get:ReqSignup.passsword)
  return _internal_passsword();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ReqSignup::set_passsword(ArgT0&& arg0, ArgT... args) {
 
 passsword_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:ReqSignup.passsword)
}
inline std::string* ReqSignup::mutable_passsword() {
  std::string* _s = _internal_mutable_passsword();
  // @@protoc_insertion_point(field_mutable:ReqSignup.passsword)
  return _s;
}
inline const std::string& ReqSignup::_internal_passsword() const {
  return passsword_.Get();
}
inline void ReqSignup::_internal_set_passsword(const std::string& value) {
  
  passsword_.Set(value, GetArenaForAllocation());
}
inline std::string* ReqSignup::_internal_mutable_passsword() {
  
  return passsword_.Mutable(GetArenaForAllocation());
}
inline std::string* ReqSignup::release_passsword() {
  // @@protoc_insertion_point(field_release:ReqSignup.passsword)
  return passsword_.Release();
}
inline void ReqSignup::set_allocated_passsword(std::string* passsword) {
  if (passsword != nullptr) {
    
  } else {
    
  }
  passsword_.SetAllocated(passsword, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (passsword_.IsDefault()) {
    passsword_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:ReqSignup.passsword)
}
