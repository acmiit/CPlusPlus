...
PROTOBUF_CONSTEXPR ReqSignup::ReqSignup(
  ...
  , passsword_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}){}
...
static ::_pb::Metadata file_level_metadata_signup_2eproto[1];
...
const uint32_t TableStruct_signup_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::ReqSignup, passsword_),
};
...
const char descriptor_table_protodef_signup_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014signup.proto\"0\n\tReqSignup\022\020\n\010username\030"
  "\001 \001(\t\022\021\n\tpasssword\030\002 \001(\tb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_signup_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_signup_2eproto = {
    false, false, 72, descriptor_table_protodef_signup_2eproto,
    "signup.proto",
    &descriptor_table_signup_2eproto_once, nullptr, 0, 1,
...
ReqSignup::ReqSignup(const ReqSignup& from)
  ...
  passsword_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    passsword_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_passsword().empty()) {
    passsword_.Set(from._internal_passsword(), 
      GetArenaForAllocation());
  }
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_passsword();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "ReqSignup.passsword"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* ReqSignup::_InternalSerialize(
  ...
  // string passsword = 2;
  if (!this->_internal_passsword().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_passsword().data(), static_cast<int>(this->_internal_passsword().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "ReqSignup.passsword");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_passsword(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:ReqSignup)
  ...
  if (!from._internal_passsword().empty()) {
    _internal_set_passsword(from._internal_passsword());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void ReqSignup::InternalSwap(ReqSignup* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &passsword_, lhs_arena,
      &other->passsword_, rhs_arena
  );
}
